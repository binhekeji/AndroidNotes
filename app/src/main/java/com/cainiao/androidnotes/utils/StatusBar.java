...
//            systemBarTintManager.setStatusBarTintColor(colorId);//设置状态栏颜色
    ...
    public static void setStatusBarTranslucent(Activity activity, boolean fontIconDark) {
        setTranslucentStatus(activity);
        if (true) {
     ...
     * 设置文字颜色
     */
    public static void setStatusBarFontIconDark(Activity activity, int type) {
        switch (type) {
            case TYPE_MIUI:
